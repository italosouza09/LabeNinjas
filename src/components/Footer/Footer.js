        ...
        <Rodape>
            <section className="services">
                <div className="div-services">
                    ...
                    <div className="div-services-columns">
                        ...
                        <button className="button-informations">Blog do LabeNinjas</button>
                    </div>
            ...
            <section className="copyright">
                <div className="copyright-text">
                    <p>©2010 - 2022, LabeNinjas Serviços de Internet. CNPJ 00.000.000/0000-00 - Corcovado, SNº - Parque Nacional da Tijuca/RJ - Brasil</p>
                </div>
            </section>
        </Rodape>
    );
